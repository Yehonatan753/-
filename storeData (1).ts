...
// --- מחלקת בעלי חיים: מסונן לפי מותגי פרימיום (האחים נחום / Zipet) ---
export const AP: Record<string, { f: { b: string[]; c: string[] }; p: Product[] }> = {
  dogs: {
    f: { b: ['Royal Canin', 'Purina Pro Plan', 'Monge', 'Josera', "Hill's", 'Ambrosia', 'AlphaDog', 'מגוון'], c: ['מזון יבש', 'מזון רטוב', 'ציוד'] },
    p: [
      { n: 'Royal Canin Mini Adult', b: 'Royal Canin', c: 'מזון יבש', d: 'מזון יבש סופר פרמיום לכלבים קטנים מ-10 ק"ג.', s: ['2 ק"ג', '8 ק"ג'], img: 'https://cdn.royalcanin-weshare-online.io/rYBngGsBaxEApQ6FnBpy/v2/mini-ad-sd-bhn-packshot' },
      { n: 'Royal Canin Maxi Adult', b: 'Royal Canin', c: 'מזון יבש', d: 'מזון סופר פרמיום לכלבים גדולים. מועשר לתמיכה במפרקים.', s: ['15 ק"ג'], img: 'https://cdn.royalcanin-weshare-online.io/C4BigGsBaxEApQ6FUhcP/v2/maxi-ad-sd-bhn-packshot' },
      { n: 'Royal Canin Puppy Medium', b: 'Royal Canin', c: 'מזון יבש', d: 'תזונה מושלמת לגורי כלבים מגזע בינוני.', s: ['15 ק"ג'], img: 'https://cdn.royalcanin-weshare-online.io/s4BjgGsBaxEApQ6F1hoP/v2/medium-puppy-bhn-packshot' },
      ...
      { n: 'Pro Plan Puppy Sensitive Skin', b: 'Purina Pro Plan', c: 'מזון יבש', d: 'מזון סלמון עשיר באומגה לגורים רגישים.', s: ['12 ק"ג'], img: 'https://www.purina.co.il/sites/default/files/styles/product_tile/public/2024-05/Pro%20Plan%20Medium%20Adult%20Chicken.png' },
      { n: 'Monge All Breeds Salmon', b: 'Monge', c: 'מזון יבש', d: 'מזון סופר פרמיום איטלקי, מבוסס סלמון ואורז.', s: ['12 ק"ג'], img: 'https://www.monge.com/wp-content/uploads/2023/04/monge-all-breeds-adult-salmon-rice.png' },
      { n: 'Josera Kids', b: 'Josera', c: 'מזון יבש', d: 'מזון גידול איכותי לגזעים בינוניים וגדולים מגרמניה.', s: ['15 ק"ג'], img: 'https://www.josera.de/media/image/product/kids-dog.png' },
      { n: 'Josera Adult Balance', b: 'Josera', c: 'מזון יבש', d: 'מזון מופחת שומן לכלבים מבוגרים או רגישים.', s: ['15 ק"ג'], img: 'https://www.josera.de/media/image/product/balance-dog.png' },
      { n: "Hill's Science Plan Large Breed", b: "Hill's", c: 'מזון יבש', d: "תזונה מדעית לכלבים מגזע גדול, לשמירה על מפרקים.", s: ['14 ק"ג'], img: 'https://www.hillspet.co.il/content/dam/cp-sites/hills/hills-pet/en_us/products/dog-food/sp-canine-adult-chicken-barley-dry.png' },
      { n: 'Ambrosia Grain Free Salmon', b: 'Ambrosia', c: 'מזון יבש', d: 'מזון ללא דגנים מבוסס סלמון, הוליסטי ומאוזן.', s: ['12 ק"ג'], img: 'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=400&q=80' },
      { n: 'AlphaDog Breeder Professional', b: 'AlphaDog', c: 'מזון יבש', d: 'שק חיסכון מקצועי למגדלים, כלבי עבודה ופנסיונים.', s: ['22 ק"ג'], img: 'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=400&q=80' },
      { n: 'מעדן Monge עוף וירקות', b: 'Monge', c: 'מזון רטוב', d: 'פחית שימורים סופר פרמיום מאיטליה.', s: ['400 גרם'], img: 'https://www.monge.com/wp-content/uploads/2023/04/monge-dog-grill-chicken.png' },
      { n: 'מיטה אורטופדית לכלב', b: 'מגוון', c: 'ציוד', d: 'מיטה איכותית רחיצה לתמיכה מושלמת.', s: ['M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=400&q=80' },
      { n: 'רתמת K9 מקצועית', b: 'מגוון', c: 'ציוד', d: 'רתמה ארגונומית חזקה במיוחד לכלבי עבודה וטיולים.', s: ['S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=400&q=80' }
    ],
  },
  cats: {
    f: { b: ['Royal Canin', 'Purina Pro Plan', 'Friskies', 'Monge', 'Josera', "Hill's", 'Ambrosia', 'Ever Clean', 'מגוון'], c: ['מזון יבש', 'מזון רטוב', 'חול', 'ציוד'] },
    p: [
      { n: 'Royal Canin Sterilised 37', b: 'Royal Canin', c: 'מזון יבש', d: 'מזון מותאם לחתולים מסורסים לשמירה על משקל תקין.', s: ['4 ק"ג', '10 ק"ג'], img: 'https://cdn.royalcanin-weshare-online.io/woDigGsBaxEApQ6FWhfg/v2/sterilised-37-fhn-packshot' },
      ...
      { n: 'Friskies Seafood Sensations', b: 'Friskies', c: 'מזון יבש', d: 'תערובת טעמי ים שחתולים טורפים, מבית פורינה.', s: ['10 ק"ג'], img: 'https://www.purina.co.il/sites/default/files/styles/product_tile/public/2024-05/Friskies%20Adult%20Cat.png' },
      { n: 'Monge Cat Kitten', b: 'Monge', c: 'מזון יבש', d: 'סופר פרמיום איטלקי, ללא סויה, לגורים בהתפתחות.', s: ['1.5 ק"ג', '10 ק"ג'], img: 'https://www.monge.com/wp-content/uploads/2023/04/monge-cat-kitten.png' },
      { n: 'Josera Catelux', b: 'Josera', c: 'מזון יבש', d: 'מזון מושלם לחתולים אניני טעם, מסייע במניעת כדורי פרווה.', s: ['10 ק"ג'], img: 'https://www.josera.de/media/image/product/catelux-cat.png' },
      { n: "Hill's Feline Adult", b: "Hill's", c: 'מזון יבש', d: "נוסחה מדויקת לאיזון מינרלים וחיזוק השרירים.", s: ['10 ק"ג'], img: 'https://www.hillspet.co.il/content/dam/cp-sites/hills/hills-pet/en_us/products/cat-food/sp-feline-adult-chicken-dry.png' },
      { n: 'מעדני פאוצ` Pro Plan', b: 'Purina Pro Plan', c: 'מזון רטוב', d: 'נתחים מובחרים ברוטב לשמירה על לחות גוף החתול.', s: ['85 גרם x 12'], img: 'https://www.purina.co.il/sites/default/files/styles/product_tile/public/2024-05/Pro%20Plan%20Adult%20Cat%20Chicken.png' },
      { n: 'Ever Clean Extra Strong Clumping', b: 'Ever Clean', c: 'חול', d: 'חול מתגבש סופר-פרמיום, מנטרל ריחות בעוצמה גבוהה.', s: ['10 ליטר'], img: 'https://images.unsplash.com/photo-1585664811087-47f65abbad64?w=400&q=80' },
      { n: 'Ever Clean Multiple Cat', b: 'Ever Clean', c: 'חול', d: 'מיועד לבתים עם מספר חתולים, התגבשות אולטימטיבית.', s: ['10 ליטר'], img: 'https://images.unsplash.com/photo-1585664811087-47f65abbad64?w=400&q=80' },
      { n: 'עץ גירוד 3 קומות', b: 'מגוון', c: 'ציוד', d: 'מתקן תעסוקה יציב לחתול, כולל בית מסתור ומשטחי גירוד.', s: [], img: 'https://images.unsplash.com/photo-1585664811087-47f65abbad64?w=400&q=80' }
    ],
  },
  birds: {
    f: { b: ['Medioni', 'מגוון'], c: ['מזון', 'ציוד'] },
    p: [
      { n: 'מדיוניקס תוכונים', b: 'Medioni', c: 'מזון', d: 'תערובת זרעים מאוזנת ונקייה המותאמת במיוחד לתוכונים.', s: ['1 ק"ג', '4 ק"ג', '20 ק"ג'], img: 'https://medioni.co.il/wp-content/uploads/2017/02/600-IMG_7877_%D7%AA%D7%95%D7%9B%D7%95%D7%A0%D7%99%D7%9D_1_%D7%A7%D7%92-300x300.jpg' },
      { n: 'מדיוניקס קוקטיל וציפורי אהבה', b: 'Medioni', c: 'מזון', d: 'תערובת עשירה ומגוונת לתוכים בינוניים.', s: ['1 ק"ג', '4 ק"ג'], img: 'https://medioni.co.il/wp-content/uploads/2017/09/600-IMG_7873_%D7%A7%D7%95%D7%A7%D7%95%D7%98%D7%9C_1_%D7%A7%D7%92-300x300.jpg' },
      ...
      { n: 'כלוב האכלה לתוכי גדול A11', b: 'מגוון', c: 'ציוד', d: 'כלוב מתכת אל-חלד על גלגלים כולל כלי אוכל.', s: [], img: 'https://images.unsplash.com/photo-1552728089-57bdde30beb3?w=400&q=80' }
    ],
  },
  rodents: {
    f: { b: ['Medioni', 'מגוון'], c: ['מזון', 'ציוד'] },
    p: [
      ...
      { n: 'מצע שבבי עץ דחוסים', b: 'מגוון', c: 'ציוד', d: 'מצע טבעי למכרסמים, סופח ריחות מעולה.', s: ['15 ליטר', '60 ליטר'], img: 'https://images.unsplash.com/photo-1425082661705-1834bfd09dca?w=400&q=80' }
    ],
  },
  reptiles: {
    f: { b: ['מגוון', 'Tetra'], c: ['מזון', 'ציוד'] },
    p: [
      ...
      { n: 'טרריום זכוכית מאובזר', b: 'מגוון', c: 'ציוד', d: 'טרריום לזוחלים כולל אוורור והכנה למנורות חימום.', s: ['45x45x60 ס"מ'], img: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400&q=80' },
      { n: 'נורת חימום UVB', b: 'מגוון', c: 'ציוד', d: 'נורה חיונית לספיגת סידן ובריאות זוחלי מדבר ויער.', s: ['100W', '150W'], img: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400&q=80' }
    ],
  },
};

// --- מחלקת אקווטיקה: דגים וציוד (מסונן מותגי פרימיום) ---
...
export const NP: Record<string, NurseryProduct[]> = {
  ...
  'garden-yearly': [
    ...
    { n: 'הליוג' + 'ין', b: 'ירוק לבן', d: 'צמח גינה עמיד ויפהפה.', img: 'https://yarok-lavan.co.il/wp-content/uploads/2025/06/2019122612585622-400x300.jpg' },
