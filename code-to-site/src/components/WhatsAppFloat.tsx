const WhatsAppFloat = () => {
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-50 w-[60px] h-[60px] rounded-full bg-whatsapp flex items-center justify-center shadow-lg shadow-whatsapp/40 hover:scale-110 transition-transform animate-float-bounce"
    >
